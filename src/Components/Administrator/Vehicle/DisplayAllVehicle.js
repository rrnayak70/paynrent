...
export default function DisplayAllVehicle(props){
 ...
 const handleEditData=async()=>{
  var body={vehicleid:vehicleId,categoryid:categoryId,subcategoryid:subcategoryId,companyid:companyId,modelid:modelId,vendorid:vendorId,registrationno:registrationNo,color:color,fueltype:fueltype,ratings:ratings,average:average,remarks:remarks,capacity:capacity,status:status,feature:feature}
