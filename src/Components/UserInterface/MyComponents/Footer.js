              ...
              >
                <Box sx={{ padding: "10px 0px", display:"flex",flexDirection:"column",alignItems:"flex-start" }}>
                  ...
                  <Box>
                   ...
                   <Box sx={{height:"40px",width:"230px",border:"1px solid #4D4D4D",borderRadius:"5px",display:"flex",alignContent:"center" }}><a><img src='https://www.revv.co.in/assets/RentalImages/HomeScreen/rental2021/logo/appstore_apple.webp' width="25px" />Download <b>App Store</b></a></Box>
